                    ...
                    <section className='containerTable'>
                        <table className=''>
                            <tbody>
                                ...
                                {data.map((dat, Key) => {
                                    if(dat.data.categoria === 'super prime' && dat.data.dias.length === 5){
                                            return(
                        ...
                        <section className='containerTable'>
                            <table className=''>
                                <tbody>
                                    ...
                                    {data.map((dat, Key) => {
                                        if(dat.data.categoria === 'super prime' && dat.data.dias[0] === 'sabado'){
                                                return(
                                                    <tr key={Key} className='rowTable'>
                        ...
                        <section className='containerTable'>
                            <table className=''>
                                <tbody>
                                    ...
                                    {data.map((dat, Key) => {
                                        if(dat.data.categoria === 'super prime' && dat.data.dias[0] === 'domingo'){
                                                return(
                                                    <tr key={Key} className='rowTable'>
